...
const VOICE_UI = {
  es: {
    ...
    proVerifyNewText: 'Se ha cargado un texto nuevo — léelo y vuelve a intentarlo',
  ...
  th: {
    ...
    proVerifyNewText: 'โหลดข้อความใหม่แล้ว — อ่านแล้วลองอีกครั้ง',
  ...
  en: {
    ...
    proVerifyNewText: 'A new text was loaded — read it and try again',
