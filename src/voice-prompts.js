...
const VOICE_UI = {
  es: {
    ...
    autoCollectLabel: 'Añadir mi voz al dictar',
    autoCollectHint: 'Si un dictado suena como tú, se añade solo a las muestras PRO. Al llegar al máximo, las grabaciones automáticas más antiguas dejan sitio a las nuevas.',
    proDeleteAll: 'Eliminar muestras PRO',
    proVerifyTitle: 'Texto de verificación',
    proVerifyCopy: 'Verifica que la voz es tuya: pulsa el micrófono y el texto aparecerá al instante. Léelo en voz alta enseguida y sin pausas (una sola vez) y pulsa el botón de enviar al terminar — el texto caduca en segundos.',
    proVerifyIdleHint: 'El texto de verificación aparecerá cuando empieces a grabar.',
    ...
    proVerifyTooShort: 'Sigue leyendo — la grabación debe durar al menos 8 segundos',
    proVerifyNewText: 'Pulsa el micrófono para intentarlo de nuevo con un texto nuevo',
    proVerifyMaxAttempts: 'Has agotado los intentos de verificación por ahora. Inténtalo de nuevo después de {time}.',
  ...
  th: {
    ...
    autoCollectLabel: 'เพิ่มเสียงของฉันขณะพูด',
    autoCollectHint: 'ถ้าเสียงพูดตรงกับเสียงของคุณ ระบบจะเพิ่มลงตัวอย่าง PRO ให้เอง เมื่อเต็มแล้ว คลิปอัตโนมัติที่เก่าที่สุดจะถูกแทนที่ด้วยคลิปใหม่',
    proDeleteAll: 'ลบตัวอย่าง PRO',
    proVerifyTitle: 'ข้อความยืนยันตัวตน',
    proVerifyCopy: 'ยืนยันว่าเป็นเสียงของคุณ: กดไมโครโฟนแล้วข้อความจะปรากฏทันที อ่านออกเสียงทันทีโดยไม่หยุดพัก (อ่านครั้งเดียว) แล้วกดปุ่มส่งเมื่ออ่านจบ — ข้อความจะหมดอายุในไม่กี่วินาที',
    proVerifyIdleHint: 'ข้อความยืนยันจะปรากฏเมื่อคุณเริ่มบันทึก',
    ...
    proVerifyTooShort: 'อ่านต่อไป — การบันทึกต้องยาวอย่างน้อย 8 วินาที',
    proVerifyNewText: 'กดไมโครโฟนเพื่อลองใหม่ด้วยข้อความใหม่',
    proVerifyMaxAttempts: 'ใช้สิทธิ์ยืนยันครบแล้วในตอนนี้ ลองใหม่หลัง {time}',
  ...
  en: {
    ...
    autoCollectLabel: 'Add my voice while dictating',
    autoCollectHint: 'When a dictation sounds like you, it is added to the PRO samples automatically. Once full, the oldest automatic clips make room for new ones.',
    proDeleteAll: 'Delete PRO samples',
    proVerifyTitle: 'Verification text',
    proVerifyCopy: 'Verify the voice is yours: press the mic and the text will appear instantly. Read it out loud right away without pausing (only once) and press send when done — the text expires within seconds.',
    proVerifyIdleHint: 'The verification text will appear when you start recording.',
    ...
    proVerifyTooShort: 'Keep reading — the recording must last at least 8 seconds',
    proVerifyNewText: 'Press the mic to try again with a new text',
    proVerifyMaxAttempts: 'You have used up the verification attempts for now. Try again after {time}.',
